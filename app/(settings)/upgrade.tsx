...
const s = StyleSheet.create({
  ...
  heroTitle: { fontSize: 26, fontWeight: FONT.black, color: COLORS.text, marginBottom: 8 },
  heroSub: {
    fontSize: 14,
  ...
  toggleText: { fontSize: 14, fontWeight: FONT.semibold, color: COLORS.textSecondary },
  toggleTextOn: { color: COLORS.text, fontWeight: FONT.bold },
  saveBadge: {
  ...
  saveBadgeText: { fontSize: 9, fontWeight: FONT.extrabold, color: '#FFF', letterSpacing: 0.6 },
  planCard: {
    backgroundColor: COLORS.surface,
    borderRadius: 20,
    padding: 22,
  ...
  price: { fontSize: 40, fontWeight: FONT.black, color: COLORS.primary },
  priceUnit: { fontSize: 18, fontWeight: FONT.semibold, color: COLORS.textSecondary },
  ...
  buyBtnText: { fontSize: 16, fontWeight: FONT.extrabold, color: '#FFF' },
  note: {
    fontSize: 11,
