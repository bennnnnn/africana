    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={close}>
      ...
      >
        <View style={{ backgroundColor: COLORS.white, borderRadius: RADIUS.xxl, padding: 22 }}>
          ...
          >
            {alreadyReported ? UI_LABELS.alreadyReported : `Report ${reportedUserName}`}
          </Text>
          <Text
          ...
          <View style={{ flexDirection: 'row', gap: 12, marginTop: 18 }}>
            ...
            <TouchableOpacity
              activeOpacity={0.85}
              onPress={() => (alreadyReported ? close() : void submit())}
              disabled={submitting}
              style={{
                flex: 1,
                minHeight: 50,
                ...
                alignItems: 'center',
                justifyContent: 'center',
                backgroundColor: alreadyReported ? COLORS.textStrong : COLORS.textStrong,
                flexDirection: 'row',
                gap: 8,
                opacity: submitting ? 0.7 : 1,
              }}
            >
              ...
              >
                {alreadyReported ? UI_LABELS.ok : UI_LABELS.report}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
